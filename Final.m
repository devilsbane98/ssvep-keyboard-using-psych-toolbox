...
while ~KbCheck
 ...
 for i=1:4
  ...
  Screen('DrawTexture', window, imageTexture2, [], [a,0,a*2,b], 0, [], thisContrast(1,2));
  Screen('DrawTexture', window, imageTexture3, [], [2*a,0,a*3,b], 0, [], thisContrast(1,3));
  Screen('DrawTexture', window, imageTexture4, [], [a*3,0,a*4,b], 0, [], thisContrast(1,4));
  Screen('DrawTexture', window, imageTexture5, [], [a*4,0,a*5,b], 0, [], thisContrast(1,5));
  Screen('DrawTexture', window, imageTexture6, [], [a*5,0,a*6,b], 0, [], thisContrast(1,6));
  Screen('DrawTexture', window, imageTexture7, [], [6*a,0,a*7,b], 0, [], thisContrast(1,7));
  Screen('DrawTexture', window, imageTexture8, [], [a*7,0,a*8,b], 0, [], thisContrast(1,8));
  Screen('DrawTexture', window, imageTexture9, [], [a*8,0,a*9,b], 0, [], thisContrast(1,9));
  Screen('DrawTexture', window, imageTexture0, [], [a*9,0,a*10,b], 0, [], thisContrast(1,10));
  Screen('DrawTexture', window, imageTextureQ, [], [0,b,a,b*2], 0, [], thisContrast(2,1));
  Screen('DrawTexture', window, imageTextureW, [], [a,b,a*2,b*2], 0, [], thisContrast(2,2));
  Screen('DrawTexture', window, imageTextureE, [], [a*2,b,a*3,b*2], 0, [], thisContrast(2,3));
  Screen('DrawTexture', window, imageTextureR, [], [a*3,b,a*4,b*2], 0, [], thisContrast(2,4));
  Screen('DrawTexture', window, imageTextureT, [], [a*4,b,a*5,b*2], 0, [], thisContrast(2,5));
  Screen('DrawTexture', window, imageTextureY, [], [a*5,b,a*6,b*2], 0, [], thisContrast(2,6));
  Screen('DrawTexture', window, imageTextureU, [], [a*6,b,a*7,b*2], 0, [], thisContrast(2,7));
  Screen('DrawTexture', window, imageTextureI, [], [a*7,b,a*8,b*2], 0, [], thisContrast(2,8));
  Screen('DrawTexture', window, imageTextureO, [], [a*8,b,a*9,b*2], 0, [], thisContrast(2,9));
  Screen('DrawTexture', window, imageTextureP, [], [a*9,b,a*10,b*2], 0, [], thisContrast(2,10));
  Screen('DrawTexture', window, imageTextureA, [], [0,b*2,a,b*3], 0, [], thisContrast(3,1));
  Screen('DrawTexture', window, imageTextureS, [], [a,b*2,a*2,b*3], 0, [], thisContrast(3,2));
  Screen('DrawTexture', window, imageTextureD, [], [a*2,b*2,a*3,b*3], 0, [], thisContrast(3,3));
  Screen('DrawTexture', window, imageTextureF, [], [a*3,b*2,a*4,b*3], 0, [], thisContrast(3,4));
  Screen('DrawTexture', window, imageTextureG, [], [a*4,b*2,a*5,b*3], 0, [], thisContrast(3,5));
  Screen('DrawTexture', window, imageTextureH, [], [a*5,b*2,a*6,b*3], 0, [], thisContrast(3,6));
  Screen('DrawTexture', window, imageTextureJ, [], [a*6,b*2,a*7,b*3], 0, [], thisContrast(3,7));
  Screen('DrawTexture', window, imageTextureK, [], [a*7,b*2,a*8,b*3], 0, [], thisContrast(3,8));
  Screen('DrawTexture', window, imageTextureL, [], [a*8,b*2,a*9,b*3], 0, [], thisContrast(3,9));
  Screen('DrawTexture', window, imageTexturespace, [], [a*9,b*2,a*10,b*3], 0, [], thisContrast(3,10));
  Screen('DrawTexture', window, imageTextureZ, [], [0,b*3,a,b*4], 0, [], thisContrast(4,1));
  Screen('DrawTexture', window, imageTextureX, [], [a,b*3,a*2,b*4],0, [], thisContrast(4,2));
  Screen('DrawTexture', window, imageTextureC, [], [a*2,b*3,a*3,b*4], 0, [], thisContrast(4,3));
  Screen('DrawTexture', window, imageTextureV, [], [a*3,b*3,a*4,b*4], 0, [], thisContrast(4,4));
  Screen('DrawTexture', window, imageTextureB, [], [a*4,b*3,a*5,b*4], 0, [], thisContrast(4,5));
  Screen('DrawTexture', window, imageTextureN, [], [a*5,b*3,a*6,b*4], 0, [], thisContrast(4,6));
  Screen('DrawTexture', window, imageTextureM, [], [a*6,b*3,a*7,b*4], 0, [], thisContrast(4,7));
  Screen('DrawTexture', window, imageTexturecomma, [], [a*7,b*3,a*8,b*4], 0, [], thisContrast(4,8));
  Screen('DrawTexture', window, imageTexturedot, [], [a*8,b*3,a*9,b*4], 0, [], thisContrast(4,9));
  Screen('DrawTexture', window, imageTextureback, [], [a*9,b*3,a*10,b*4], 0, [], thisContrast(4,10));
